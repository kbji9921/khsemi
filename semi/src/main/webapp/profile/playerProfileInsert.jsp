<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<% String trainerId = (String)request.getSession().getAttribute("player"); %>
        ...
        <div class="box">
            ...
            <div  class="row center m30">
           	<img src="<%=request.getContextPath()%>/images/profile.png" width="80%">
           	 <div  class="row center">
        	<input type="file" accept="jpg,png" name="trainerAttachment" class="form-input input-round">
        	<input type="hidden" name="playerId" value="<%=trainerId%>">
       	</div>

<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%--footer --%>
		<footer class="footer">
			...
			<p>강남지원 1관 : 서울특별시 강남구 테헤란로14길 6 남도빌딩 2F, 3F, 4F, 5F, 6F<br>
			...
			<p class="footer-copyright">Copyright © 1998-2022 KH Information Educational Institute All Right Reserved</p>
		</footer>
	</main>
</body>
</html>